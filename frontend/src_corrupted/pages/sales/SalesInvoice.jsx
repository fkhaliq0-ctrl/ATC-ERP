...
const SalesInvoice = () => {
  ...
  const handleEntryKeyDown = (e, field) => {
    if (e.key === 'Enter') {
      ...
      if (field === 'category') {
        if (categoryRefs.current[0]) {
          const ev = new MouseEvent('mousedown', { bubbles: true, cancelable: true });
          categoryRefs.current[0].dispatchEvent(ev);
          categoryRefs.current[0].focus();
        }
        return;
      }
      
      // Navigation: category -> description -> quantity -> rate -> add item
      const fields = ['description', 'quantity', 'rate'];
      ...
      if (field === 'rate') {
        ...
        if (added) {
          setTimeout(() => focusNextField(categoryRefs.current[0]), 100);
        }
        return;
      }
  ...
  const handleEdit = (invoice) => {
    ...
    setFormData({
      ...
      weekBeforeDate: invoice.weekBeforeDate || '',
      dayBeforeDate: invoice.dayBeforeDate || '',
    });
    if (invoice.items) {
          ...
          <div style={{
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr 1fr 1fr', gap: '8px', marginBottom: '6px', flexShrink: 0 }}>
              <div>
                ...
                <input name="salesInvoiceNo" value={formData.salesInvoiceNo} onChange={handleChange} onKeyDown={handleEnterPrevent} style={inputStyle} />
              </div>
              <div>
                <label style={{ display: 'block', fontSize: '10px', fontWeight: '600', color: '#555', marginBottom: '2px' }}>Invoice Date</label>
                <input type="date" name="salesInvoiceDate" value={formData.salesInvoiceDate} onChange={handleChange} onKeyDown={handleEnterPrevent} style={inputStyle} />
              </div>
              <div>
                <label style={{ display: 'block', fontSize: '10px', fontWeight: '600', color: '#555', marginBottom: '2px' }}>Book No.</label>
                <input name="bookNo" value={formData.bookNo} onChange={handleChange} onKeyDown={handleEnterPrevent} placeholder="Book No" style={inputStyle} />
              </div>
              <div>
                <label style={{ display: 'block', fontSize: '10px', fontWeight: '600', color: '#555', marginBottom: '2px' }}>Customer Order No.</label>
                <input name="customerOrderNo" value={formData.customerOrderNo} onChange={handleChange} onKeyDown={handleEnterPrevent} placeholder="Order no" style={inputStyle} />
              </div>
              <div>
                <label style={{ display: 'block', fontSize: '10px', fontWeight: '600', color: '#555', marginBottom: '2px' }}>Order Date</label>
                <input type="date" name="orderDate" value={formData.orderDate} onChange={handleChange} onKeyDown={handleEnterPrevent} style={inputStyle} />
              </div>
            </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '8px', marginBottom: '6px', flexShrink: 0 }}>
              <div style={{ border: '1px solid #e8ecf1', borderRadius: '6px', padding: '6px 8px', background: '#fafbfc' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '3px' }}>
                  <select name="customerId" value={formData.customerId} onChange={handleCustomerSelect} onKeyDown={handleEnterPrevent} style={{ ...inputStyle, height: '24px', fontSize: '10px' }}>
                    <option value="">-- Select --</option>
                    <option value="-1">+ Add New</option>
                    {customers.map(c => <option key={c.id} value={c.id}>{c.name}</option>)}
                  </select>
                  <input name="customer" value={formData.customer} onChange={handleChange} onKeyDown={handleEnterPrevent} placeholder="Customer Name" style={{ ...inputStyle, height: '24px', fontSize: '10px' }} />
                </div>
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '3px', marginTop: '3px' }}>
                  <input name="address" value={formData.address} onChange={handleChange} onKeyDown={handleEnterPrevent} placeholder="Address" style={{ ...inputStyle, height: '24px', fontSize: '10px' }} />
                  <input name="city" value={formData.city} onChange={handleChange} onKeyDown={handleEnterPrevent} placeholder="City" style={{ ...inputStyle, height: '24px', fontSize: '10px' }} />
                  <input name="state" value={formData.state} onChange={handleChange} onKeyDown={handleEnterPrevent} placeholder="State" style={{ ...inputStyle, height: '24px', fontSize: '10px' }} />
                </div>
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '3px', marginTop: '3px' }}>
                  <input name="stateCode" value={formData.stateCode} onChange={handleChange} onKeyDown={handleEnterPrevent} placeholder="State Code" style={{ ...inputStyle, height: '24px', fontSize: '10px' }} />
                  <input name="phone" value={formData.phone} onChange={handleChange} onKeyDown={handleEnterPrevent} placeholder="Phone" style={{ ...inputStyle, height: '24px', fontSize: '10px' }} />
                  <select name="customerDocType" value={formData.customerDocType} onChange={handleChange} onKeyDown={handleEnterPrevent} style={{ ...inputStyle, height: '24px', fontSize: '10px' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '3px', marginTop: '3px' }}>
                  <input name="customerDocNumber" value={formData.customerDocNumber} onChange={handleChange} onKeyDown={handleEnterPrevent} placeholder="Document No." style={{ ...inputStyle, height: '24px', fontSize: '10px' }} />
                  <input name="country" value={formData.country} onChange={handleChange} onKeyDown={handleEnterPrevent} placeholder="Country" style={{ ...inputStyle, height: '24px', fontSize: '10px' }} />
                </div>
              </div>
              ...
              <div style={{ border: '1px solid #e8ecf1', borderRadius: '6px', padding: '6px 8px', background: '#fafbfc' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '3px' }}>
                  <input name="consigneeName" value={formData.consigneeName} onChange={handleChange} onKeyDown={handleEnterPrevent} placeholder="Name" style={{ ...inputStyle, height: '24px', fontSize: '10px' }} />
                  <input name="consigneeAddress" value={formData.consigneeAddress} onChange={handleChange} onKeyDown={handleEnterPrevent} placeholder="Address" style={{ ...inputStyle, height: '24px', fontSize: '10px' }} />
                </div>
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '3px', marginTop: '3px' }}>
                  <input name="consigneeCity" value={formData.consigneeCity} onChange={handleChange} onKeyDown={handleEnterPrevent} placeholder="City" style={{ ...inputStyle, height: '24px', fontSize: '10px' }} />
                  <input name="consigneeState" value={formData.consigneeState} onChange={handleChange} onKeyDown={handleEnterPrevent} placeholder="State" style={{ ...inputStyle, height: '24px', fontSize: '10px' }} />
                  <input name="consigneeStateCode" value={formData.consigneeStateCode} onChange={handleChange} onKeyDown={handleEnterPrevent} placeholder="State Code" style={{ ...inputStyle, height: '24px', fontSize: '10px' }} />
                </div>
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '3px', marginTop: '3px' }}>
                  <input name="consigneePhone" value={formData.consigneePhone} onChange={handleChange} onKeyDown={handleEnterPrevent} placeholder="Phone" style={{ ...inputStyle, height: '24px', fontSize: '10px' }} />
                  <select name="consigneeDocType" value={formData.consigneeDocType} onChange={handleChange} onKeyDown={handleEnterPrevent} style={{ ...inputStyle, height: '24px', fontSize: '10px' }}>
                    {documentTypes.map(d => <option key={d} value={d}>{d}</option>)}
                  </select>
                  <input name="consigneeDocNumber" value={formData.consigneeDocNumber} onChange={handleChange} onKeyDown={handleEnterPrevent} placeholder="Document No." style={{ ...inputStyle, height: '24px', fontSize: '10px' }} />
                </div>
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '3px', marginTop: '3px' }}>
                  <input name="consigneeCountry" value={formData.consigneeCountry} onChange={handleChange} onKeyDown={handleEnterPrevent} placeholder="Country" style={{ ...inputStyle, height: '24px', fontSize: '10px' }} />
                </div>
              </div>
            </div>
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '6px' }}>
                <span style={{ fontSize: '10px', fontWeight: '700', color: '#1a237e', textTransform: 'uppercase', letterSpacing: '0.5px' }}>
                  Payment Tracking
                </span>
                <select
                  name="paymentStatus"
                  ...
                  style={{
                    ...
                    fontSize: '10px',
                    fontWeight: '600',
                    color: formData.paymentStatus === 'Paid' ? '#2e7d32' : formData.paymentStatus === 'Partial' ? '#ed6c02' : '#d32f2f',
                    borderColor: formData.paymentStatus === 'Paid' ? '#2e7d32' : formData.paymentStatus === 'Partial' ? '#ed6c02' : '#d32f2f',
                    backgroundColor: formData.paymentStatus === 'Paid' ? '#e8f5e9' : formData.paymentStatus === 'Partial' ? '#fff3e0' : '#ffebee',
                  }}
                >
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '8px' }}>
                {/* Advance (30%) */}
                <div style={{ padding: '6px', background: '#fff', borderRadius: '4px', border: '1px solid #e0e0e0' }}>
                  <div style={{ fontSize: '9px', fontWeight: '600', color: '#1976d2', marginBottom: '4px' }}>Advance (30%)</div>
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '3px' }}>
                    <input
                      value={formatCurrency(grandTotal * 0.30)}
                      readOnly
                      style={{ ...inputStyle, fontWeight: 'bold', fontSize: '11px', color: '#1976d2', height: '22px' }}
                    />
                    <input
                      type="date"
                      name="advanceDate"
                      ...
                      onChange={handleChange}
                      style={{ ...inputStyle, height: '22px', fontSize: '10px' }}
                    />
                  </div>
                </div>
                ...
                {/* One Week Before (30%) */}
                <div style={{ padding: '6px', background: '#fff', borderRadius: '4px', border: '1px solid #e0e0e0' }}>
                  <div style={{ fontSize: '9px', fontWeight: '600', color: '#7b1fa2', marginBottom: '4px' }}>One Week Before (30%)</div>
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '3px' }}>
                    <input
                      value={formatCurrency(grandTotal * 0.30)}
                      readOnly
                      style={{ ...inputStyle, fontWeight: 'bold', fontSize: '11px', color: '#7b1fa2', height: '22px' }}
                    />
                    <input
                      type="date"
                      name="weekBeforeDate"
                      value={formData.weekBeforeDate}
                      onChange={handleChange}
                      style={{ ...inputStyle, height: '22px', fontSize: '10px' }}
                    />
                  </div>
                ...
                {/* Day Before (40%) */}
                <div style={{ padding: '6px', background: '#fff', borderRadius: '4px', border: '1px solid #e0e0e0' }}>
                  <div style={{ fontSize: '9px', fontWeight: '600', color: '#e65100', marginBottom: '4px' }}>Day Before (40%)</div>
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '3px' }}>
                    <input
                      value={formatCurrency(grandTotal * 0.40)}
                      readOnly
                      style={{ ...inputStyle, fontWeight: 'bold', fontSize: '11px', color: '#e65100', height: '22px' }}
                    />
                    <input
                      type="date"
                      name="dayBeforeDate"
                      value={formData.dayBeforeDate}
                      onChange={handleChange}
                      style={{ ...inputStyle, height: '22px', fontSize: '10px' }}
                    />
                  </div>
