...
const CustomerMaster = () => {
  ...
  const handleCityChange = (e) => {
    ...
    if (stateData[selectedCity]) {
      ...
      // Don't clear auto fields if city not found — user can edit manually
    }
  };
  ...
  return (
    <div className="page-container">
      ...
      <p className="page-subtitle">Add and manage your customers</p>
      ...
      <div className="card">
        ...
        <form>
          ...
          <button type="submit" className="btn-primary">Save Customer Master</button>
        </form>
      </div>

      <div className="card">
        <h3 className="card-title">Saved Customers List</h3>
