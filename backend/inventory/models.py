...
class PurchaseInvoice(models.Model):
    ...
    # ========== Import Expenses Fields ==========
    customs_duty = models.DecimalField(max_digits=10, decimal_places=2, default=0, blank=True, null=True)
    freight_charges = models.DecimalField(max_digits=10, decimal_places=2, default=0, blank=True, null=True)
    insurance = models.DecimalField(max_digits=10, decimal_places=2, default=0, blank=True, null=True)
    handling_charges = models.DecimalField(max_digits=10, decimal_places=2, default=0, blank=True, null=True)
    other_charges = models.DecimalField(max_digits=10, decimal_places=2, default=0, blank=True, null=True)
...
class Payment(models.Model):
    ...
    type = models.CharField(max_length=10, choices=PAYMENT_TYPE, default='Received')
